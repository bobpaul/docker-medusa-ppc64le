...
**build**
1. build `docker-unrar` as `ghcr.io/linuxserver/unrar:ppc64le-latest`
2 `docker build . -t ghcr.io/linuxserver/docker-medusa:ppc64le-latest -f Dockerfile.ppc64le`
